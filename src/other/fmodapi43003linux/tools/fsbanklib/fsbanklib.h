...
typedef enum FSBANK_FORMAT
{
    ...
    FSBANK_FORMAT_CELT,             // Constrained Energy Lapped Transform codec.
    FSBANK_FORMAT_MAX
} FSBANK_FORMAT;
...
FSBANK_RESULT F_API FSBank_Init();
FSBANK_RESULT F_API FSBank_Close();
FSBANK_RESULT F_API FSBank_IsFormatAllowed(FSBANK_FORMAT format);
FSBANK_RESULT F_API FSBank_Build(FSBANK_BUILDMODE buildmode,
                           ...
                           const char *srcdir,
                           int quality);
FSBANK_RESULT F_API FSBank_SetUpdateCallback(FSBANK_UPDATECALLBACK callback, void *userdata);
FSBANK_RESULT F_API FSBank_SetDebugCallback(FSBANK_DEBUGCALLBACK callback, void *userdata);
FSBANK_RESULT F_API FSBank_SetBuildCancel(int cancel);
FSBANK_RESULT F_API FSBank_GetBuildCancel(int *cancel);
