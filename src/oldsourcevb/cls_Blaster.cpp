...
END
Attribute VB_Name = "cls_Blaster"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
Attribute VB_Description = "The basic Blaster Gun."
...
Public Property Let AmmoCapacitor(ByVal vData As Long)
'used when assigning a value to the property, on the left side of an assignment.
'Syntax: X.AmmoCurrent = 5
    mvarAmmoCap = vData
End Property
...
Public Property Get AmmoCapacitor() As Long
'used when retrieving value of a property, on the right side of an assignment.
'Syntax: if enginelogenabled then WriteEngineLOG LOGFILE,  X.AmmoCurrent
    AmmoCapacitor = mvarAmmoCap
End Property
