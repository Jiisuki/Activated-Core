...
END
Attribute VB_Name = "cls_Boingers"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
Attribute VB_Description = "Advanced: Grenades/Boingers"
...
Private Sub Class_Initialize()
    ...
    'Ammo
        Me.AMMOMAX = 40
        Me.AmmoCurrent = 10 'Default Value on pickup
        Me.AmmoInBackpack = 0 'Default Value on gamestart
        Me.RecoilAmount = 4
    ...
    'Pickup Msg
        Me.MsgPickup = "YOU GOT THE ROCKETS!"
